...
namespace Lab3
{
    public partial class PreAuctionAssessment : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string sqlService = "INSERT INTO ServiceTicket (CustomerID, TicketOpenDate, ServiceType, PreAuctionAssessmentID, InitiatingEmp, Status_Service) VALUES (@CustomerID, @TicketOpenDate, @ServiceType, (Select TOP 1 PreAuctionAssessmentID from PreAuctionAssessment order by PreAuctionAssessmentID desc), @InitiatingEmp, @Status)";
            //Define the Connection to the Database
            ...
            sqlCommand1.Parameters.Add(new SqlParameter("@Status", "27"));
            sqlConnect1.Open();

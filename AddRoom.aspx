...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div runat="server" id="divYesBox">
        ...
        <div>
             <asp:GridView ID="grvBox"
                 ...
                 DataKeyNames="BoxID">
            <Columns>
                <asp:BoundField DataField="BoxID" Visible="false" />
    ...
    <div class="float-right">
        ...
        <asp:Button ID="BtnSave" runat="server" Text="Save" AutoPostBack="true" OnClick="BtnSave_Click" />
    </div>
     <asp:SqlDataSource ID="grdsrcBox"
        runat="server"
        ConnectionString="<%$ConnectionStrings:Lab3%>"
        SelectCommand="Select BoxID, BoxType, Box Quantity FROM SPECIALEQUIPMENT WHERE ServiceTicketID = @ServiceTicketID"

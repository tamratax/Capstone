...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:Label ID="LblCustName" runat="server" Text=""></asp:Label>
        ...
        <asp:TextBox ID="TxtStreet"
            ...
            <div class="form-row">
         <div class="form-group col-md-6">
            <label for="inputCity">Orgin City</label>
     ...
     <div class="form-group">
        <label for="inputDescription">Orgin Description</label>
        <asp:TextBox ID="TxtDescription"
            runat="server"
            class="form-control"
            placeholder="Description"></asp:TextBox>
    </div>
    <asp:Button ID="BtnAddOrgin" 
        runat="server" 
        Text="Add Another Orgin" 
        OnClick="BtnAddOrgin_Click" />
            <div class="form-group">
